<nav x-data="{ open: false }" class="bg-base border-b border-default backdrop-blur-sm sticky top-0 z-40">
                            ...
                            >
                                ...
                                <div class="p-6 space-y-6">
                                    <div class="text-center pb-4 border-b border-gray-200 dark:border-gray-700">
                                        <h3 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">NextLogへようこそ！</h3>
