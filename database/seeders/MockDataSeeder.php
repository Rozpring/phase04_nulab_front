...
class MockDataSeeder extends Seeder
{
    ...
    private function createMockPlans(int $userId): void
    {
        ...
        $plans = [
            ...
            // 今日の計画（現在時刻に基づいて動的に生成）
            // 完了済みタスク（2時間前に終了）
            [
                'title' => 'Eloquent ORMの学習',
                'plan_type' => 'study',
                'scheduled_date' => now(),
                'scheduled_time' => now()->subHours(3)->format('H:i'),
            ...
            // 現在実行中のタスク（30分前に開始、30分後に終了）
            [
                'title' => 'ユーザー管理機能の実装',
                'plan_type' => 'work',
                'scheduled_date' => now(),
                'scheduled_time' => now()->subMinutes(30)->format('H:i'),
            ...
            [
                ...
                'plan_type' => 'break',
                'scheduled_date' => now(),
                'scheduled_time' => now()->addMinutes(15)->format('H:i'),
                'end_time' => now()->addMinutes(30)->format('H:i'),
                'duration_minutes' => 15,
                'priority' => 10,
                'status' => 'planned',
            ...
            [
                ...
                'plan_type' => 'work',
                'scheduled_date' => now(),
                'scheduled_time' => now()->addMinutes(25)->format('H:i'),
                'end_time' => now()->addMinutes(85)->format('H:i'),
                'duration_minutes' => 60,
                'priority' => 7,
                'status' => 'planned',
            ...
            [
                ...
                'plan_type' => 'work',
                'scheduled_date' => now(),
                'scheduled_time' => now()->addMinutes(60)->format('H:i'),
                'end_time' => now()->addMinutes(120)->format('H:i'),
                'duration_minutes' => 60,
                'priority' => 6,
                'status' => 'planned',
                'ai_reason' => '品質向上のためテストを追加。',
            ],
        ];
